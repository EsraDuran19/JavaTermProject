...
public class Term_Project_71694 extends JFrame {
	...
	//********************* Create panel 1 and tabbedPane***************************** 
		...
		//********************* Create menu and add image to submenus. ***************************** 
	...
	//*******//Create button and label for customer registiration and displaying order to customer.**************	
	...
	//************** Execute actions if complete button is pressed.**************
...
//**************************************** PANEL 2 *******************************************************
		...
		orderButton.addActionListener(new ActionListener()    {
			...
			public void actionPerformed(ActionEvent e){
				...
				Collections.sort(orders);  //Sort by ages
				
				for (int i=0;i<orders.size()-1;i++) {   //Sort by totalprice if ages are the same.
					System.out.println();
